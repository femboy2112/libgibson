...
| **TESTED** | Covered by an automated test in this repository (`cargo test`, 657 passed: 247 unit + 410 integration; one known-red acceptance ignored) that exercises the behavior described. |
