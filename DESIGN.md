...
| **TESTED** | Covered by an automated test in this repository (`cargo test`, 661 passed: 247 unit + 413 integration + 1 doctest; one known-red acceptance ignored) that exercises the behavior described. |
