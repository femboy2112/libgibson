...
This is the exhaustive **normal (release) dependency closure**, generated
reproducibly from Cargo metadata by
`scripts/release/gen-third-party-notices.sh`; regenerate it after any
dependency change. Every crate is permissively licensed (MIT / Apache-2.0 /
Zlib / Unicode-3.0 and dual combinations); the full text of the two primary
licenses ships as `LICENSE-MIT` and `LICENSE-APACHE`. A few listed crates
are build-time proc-macros that are not linked into the shipped binary; they
...
| castaway v0.2.4 | MIT | https://github.com/sagebind/castaway |
...
| libc v0.2.189 | MIT OR Apache-2.0 | https://github.com/rust-lang/libc |
...
| taffy v0.14.0 | MIT | https://github.com/DioxusLabs/taffy |
| unicode-ident v1.0.26 | (MIT OR Apache-2.0) AND Unicode-3.0 | https://github.com/dtolnay/unicode-ident |
| unicode-segmentation v1.13.3 | MIT OR Apache-2.0 | https://github.com/unicode-rs/unicode-segmentation |
