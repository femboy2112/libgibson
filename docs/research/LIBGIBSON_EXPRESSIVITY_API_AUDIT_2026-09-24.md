...
**Date:** 2026-09-24  
**Audited baseline:** public `main` at `3438c89645c760201be4b2598cf12161efada782`  
**Also inspected:** open introductory-cinema PR #14, including its experimental `CubicPath3` route primitive. PR #14 is evidence of pressure on the API, not a dependency of this document.
...
PR #14 independently adds `CubicPath3`, motivated by cameras and semantic couriers.
...
This is the largest shared gap.
...
| Generic path/curve | low-level lines; PR14 CubicPath3 | PARTIAL | medium |
...
1. **Generic path sampling**
   - PR14 `CubicPath3` is a good proof-of-shape.
