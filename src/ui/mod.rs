...
//!
//! Components lower to ordinary [`crate::Node`] trees. [`Skin`] adds a visual
//! grammar above [`crate::Theme`]; [`UiRuntime`] routes typed actions and retains
//! bounded presentation state. The application owns all domain and editor state.
//! [`Compiled`] exposes the lowering boundary for inspection, Scene integration,
