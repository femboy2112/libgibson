...
- **Sub-cell canvases** (TESTED): `BrailleCanvas` (2×4 dots/cell) and `HalfBlockCanvas` (2 vertical RGB samples/cell via `▀`), with Bresenham lines/polylines and exact glyph/colour tests. No graphics protocol required.
...
# Run the full test suite (177 tests: 84 unit + 93 integration)
cargo test
